...
normalized permission scopes, and hash-only API credentials. Phase 10 migration
`0008_phase_10` links imported conversations to their source for provenance
