...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("GET", "/v1/key-labels", Requirement.OWNER),
        ("POST", "/v1/key-labels", Requirement.OWNER),
        ("POST", "/v1/key-labels/remove", Requirement.OWNER),
        ("GET", "/v1/key-aliases-other", Requirement.DEVICE),
        ("GET", "/v1/key-labels-other", Requirement.DEVICE),
