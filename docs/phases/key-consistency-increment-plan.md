...
implementation, and steps P1 and P2 are complete locally; steps P0 and P3 to P6
have not started and each still stops for verification. This plan does not start
