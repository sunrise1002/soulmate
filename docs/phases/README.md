...
- [Key consistency plan](key-consistency-increment-plan.md) (in progress; steps P0
  to P3 implemented), with the [P0 spike report](key-consistency-p0-spike-report.md)
