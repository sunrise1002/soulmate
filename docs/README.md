...
Start with **[index.html](index.html)** — the single-page project guide covering
...
| [architecture/](architecture/README.md) | Layering rules and implemented ADRs ADR-001 through ADR-016 |
